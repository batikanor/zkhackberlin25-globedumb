  ...
  const copyUrlToClipboard = async () => {
    if (queryUrl) {
      try {
        ...
        setMessage("✅ URL copied! Paste it in ZKPassport app or scan the QR code.")
        ...
        try {
          ...
          setMessage("✅ URL copied! Paste it in ZKPassport app.")
          setTimeout(() => setMessage("Scan the QR code with your ZKPassport mobile app"), 3000)
        } catch (fallbackErr) {
      ...
      {queryUrl && (
        <div className="mt-6 text-center">
          <div className="bg-white p-4 rounded-lg border-2 border-gray-200 inline-block">
            <QRCodeSVG value={queryUrl} size={256} />
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="text-xs text-gray-500 break-all max-w-64 max-h-24 overflow-y-auto border-t pt-2">
          ...
          <p className="text-sm text-gray-600 mt-2">
            <strong>Scan this REAL QR code with your ZKPassport mobile app</strong>
            <br />
            <span className="text-xs text-gray-500">Generated by QR Server API - 100% scannable</span>
          </p>
        </div>
      )}
